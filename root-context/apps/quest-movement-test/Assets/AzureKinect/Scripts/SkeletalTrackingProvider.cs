                        ...
                        using (Frame frame = tracker.PopResult(TimeSpan.Zero, throwOnTimeout: false))
                        {
                            ...
                            else
                            {
                                ...
                                if (colorImage != null)
                                {
                                    ...
                                    currentFrameData.ColorImageSize = colorImage.Memory.Span.Length;
                                    colorImage.Memory.Span.CopyTo(currentFrameData.ColorImage.AsSpan());
                                }
                                else
                                {
                                    currentFrameData.ColorImageWidth = 0;
                                    currentFrameData.ColorImageHeight = 0;

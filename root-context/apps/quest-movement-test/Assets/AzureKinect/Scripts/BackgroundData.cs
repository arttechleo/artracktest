...
public class BackgroundData : ISerializable
{
    ...
    // Color image frame, BGRA32 from Azure Kinect.
    ...
    public BackgroundData(int maxDepthImageSize = 1024 * 1024 * 3, int maxColorImageSize = 1920 * 1080 * 4, int maxBodiesCount = 20, int maxJointsSize = 100)
    {
